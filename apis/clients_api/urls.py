...
from apis.clients_api.clients_api_view import UserRegisterView, CookieTokenObtainPairView, ClientProfileView, UserForgotPasswordView, UserLogoutView, UserPasswordResetConfirmView, CookieTokenRefreshView, AddressCreateView, StatesListView, AddressListView
